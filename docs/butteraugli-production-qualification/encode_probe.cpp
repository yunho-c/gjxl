...
#include "encoding_benchmark.cpp"
#undef main
...
int main(int argc, char** argv) try {
  ...
  if(options.raw_samples_path.empty() && !options.gpu_profile_path.empty())
    options.raw_samples_path=(std::filesystem::path(options.gpu_profile_path).parent_path()/"samples.json").string();
