...
// Complete-pipeline goldens after the direct pinned AdjustQuantBlockAC oracle
// establishes the authoritative coefficient decisions independently.
constexpr std::array<double, 3> kGradientScores = {
  0.7736356258392334, 0.74742162227630615, 0.78040987253189087,
};
constexpr std::array<float, 6> kGradientQuant = {
  0.481455505f, 0.481455505f, 0.426575005f,
  0.481455505f, 0.481455505f, 0.478268474f,
};
constexpr std::array<int32_t, 6> kGradientRaw = {5, 5, 5, 5, 5, 6};

constexpr std::array<double, 3> kTextureScores = {
  1.3903495073318481, 1.2260046005249023, 1.1252058744430542,
};
constexpr std::array<float, 12> kTextureQuant = {
  0.291131258f, 0.291131258f, 0.291131258f, 0.291131258f,
  0.291131258f, 0.291131258f, 0.291131258f, 0.291131258f,
  0.238987684f, 0.238987684f, 0.224509716f, 0.221905366f,
};
...
constexpr std::array<double, 3> kEdgeScores = {
  0.38823622465133667, 0.24914586544036865, 0.80253523588180542,
};
constexpr std::array<float, 15> kEdgeQuant = {
  0.370857745f, 0.346477181f, 0.309596568f, 0.35718596f, 0.35718596f,
  0.370857745f, 0.346477181f, 0.309596568f, 0.35718596f, 0.35718596f,
  0.363106966f, 0.33260259f, 0.292187989f, 0.351673484f, 0.365356266f,
};
constexpr std::array<int32_t, 15> kEdgeRaw = {
  5, 5, 4, 5, 5, 5, 5, 4, 5, 5, 6, 6, 5, 6, 6,
};

constexpr std::array<double, 3> kSaturatedScores = {
  1.2764921188354492, 0.80292308330535889, 1.3861470222473145,
};
constexpr std::array<float, 12> kSaturatedQuant = {
  0.351000547f, 0.347877502f, 0.34355855f, 0.341281742f,
  0.335709423f, 0.294081807f, 0.343864679f, 0.428220242f,
  0.347975612f, 0.323266566f, 0.331760645f, 0.368506402f,
};
constexpr std::array<int32_t, 12> kSaturatedRaw = {
  5, 5, 5, 5, 5, 5, 5, 6, 5, 6, 5, 6,
};

constexpr std::array<double, 3> kColorTileBoundaryScores = {
  0.70720368623733521, 0.69819313287734985, 0.81265813112258911,
};
constexpr std::array<float, 27> kColorTileBoundaryQuant = {
  0.506190598f, 0.512174428f, 0.517240822f, 0.520653248f, 0.530720115f,
  0.5248757f, 0.515986741f, 0.458179623f, 0.456268251f,
  0.469422042f, 0.482331514f, 0.517240822f, 0.520653248f, 0.481198311f,
  0.5248757f, 0.499395162f, 0.423655868f, 0.45307526f,
  0.434340417f, 0.428474247f, 0.407101005f, 0.409248888f, 0.397621751f,
  0.392315358f, 0.428627938f, 0.408101439f, 0.415920824f,
};
