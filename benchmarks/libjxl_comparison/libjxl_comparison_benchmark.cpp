...
#error "GJXL_LIBJXL_REVISION must identify the stock libjxl base"
#endif

#ifndef GJXL_LIBJXL_LINKED_REVISION
#error "GJXL_LIBJXL_LINKED_REVISION must identify the linked libjxl checkout"
#endif
...
void WriteRawSamples(const std::filesystem::path &destination,
  ...
  try {
    ...
    output << "  \"stage_profile_enabled\": "
           ...
           << "  \"linked_revision\": \"" << GJXL_LIBJXL_LINKED_REVISION
           << "\",\n"
